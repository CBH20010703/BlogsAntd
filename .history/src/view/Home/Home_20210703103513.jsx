        ...
        return (
            ...
            <div style={{ padding: "20px" }}>
                <QueueAnim delay={300} className="queue-simple">
                    <Descriptions title="About Me" column={4}>
                    ...
                    <Descriptions title="Blog Technology Selection" column={4}>

                        <Descriptions.Item key="a" contentStyle={{ fontSize: "1rem" }} span={3} label="前端"><Html5Outlined /> React</Descriptions.Item>
