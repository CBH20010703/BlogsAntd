            ...
            <div style={{ padding: "20px" }}>
                <QueueAnim delay={300} className="queue-simple">
                    <Descriptions title="About Me">
                        ...
                        <Descriptions.Item label={<GlobalOutlined />} column={4} span={2}>
                    ...
                    <Descriptions title="Blog Technology Selection">
                        ...
                        <Descriptions.Item key="b" contentStyle={{ fontSize: "1rem" }} column={4} span={3} label="前端库"><AntDesignOutlined /> Antd</Descriptions.Item>
                        <Descriptions.Item key="c" contentStyle={{ fontSize: "1rem" }} column={4} span={3} label="后端">Net Core</Descriptions.Item>
                        <Descriptions.Item key="d" contentStyle={{ fontSize: "1rem" }} column={4} span={3} label="数据库"><ConsoleSqlOutlined /> Mysql</Descriptions.Item>
                        <Descriptions.Item key="f" contentStyle={{ fontSize: "1rem" }} column={4} span={3} label="服务器"><AliyunOutlined /> 阿里云</Descriptions.Item>
